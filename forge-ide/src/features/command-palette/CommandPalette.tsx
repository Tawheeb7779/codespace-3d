...
export function CommandPalette() {
  ...
  const commands: Command[] = useMemo(() => {
    ...
    return [
      ...
      { id: 'packages', label: 'Open Packages', icon: Package, run: () => ui.setLeftPanel('packages') },
      { id: 'tasks', label: 'Open Tasks', icon: ListTodo, run: () => ui.setLeftPanel('tasks') },
      { id: 'sql', label: 'Open SQL Studio', icon: Database, run: () => ui.setLeftPanel('sql') },
      { id: 'assets', label: 'Open Assets', icon: Image, run: () => ui.setLeftPanel('assets') },
      { id: 'analytics', label: 'Open Analytics', icon: BarChart3, run: () => ui.setLeftPanel('analytics') },
